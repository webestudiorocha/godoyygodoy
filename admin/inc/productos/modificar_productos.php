...
if ($borrarImg != '') {
    ...
    $imagenes->delete();
    $funciones->headerMove(URL . "/index/modificarProductos&cod=$cod");
}
    ...
    <form method="post" class="row" enctype="multipart/form-data">
        ...
        <label class="col-md-3">Subcategoría:<br/>
            <select name="subcategoria">
                <option value="<?=$producto["subcategoria"]?>" selected><?=$producto["subcategoria"]?></option>
                <option value="" disabled>-- categorías --</option>
                <option value="Novedades">Novedades</option>
                <option value="Marketing">Marketing</option>
                <option value="Social">Social</option>
        ...
        <label class="col-md-3">Código:<br/>
            <input type="text" name="cod" value="<?=$producto["cod"]?>">
        </label>
