...
if ($borrarImg != '') {
    ...
    $imagenes->delete();
    $funciones->headerMove(URL . "/index/modificarNovedades&cod=$cod");
}
...
if (isset($_POST["agregar"])) {
    ...
    $novedades->edit();
    $funciones->headerMove(URL . "/index/verNovedades");
}
?>
    ...
    <form method="post" class="row" enctype="multipart/form-data">
        ...
        <label class="col-md-4">Categoría:<br/>
            <select name="categoria">
                <option value="<?=$novedad["categoria"]?>" selected><?=$novedad["categoria"]?></option>
        ...
        <label class="col-md-12">Desarrollo:<br/>
            <textarea name="desarrollo" class="ckeditorTextarea"><?=$novedad["desarrollo"];?></textarea>
        </label>
        <div class="clearfix"></div>
